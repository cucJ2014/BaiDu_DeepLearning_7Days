...
class ConvPool(fluid.dygraph.Layer):
    '''卷积+池化'''
    def __init__(self,num_channels,num_filters,groups,filter_size=3,conv_stride=1,conv_padding=1,act='relu',pool_size=2,pool_type='max',pool_stride=2,pool_padding=0):
